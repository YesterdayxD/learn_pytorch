...
dist_backend = 'nccl'
world_size = 2
model_file='/home/limk/pytorch_distributed/save.pth'
...
if os.path.exists(model_file):
    cnn.module.load_state_dict(torch.load(model_file)['model_state_dict'])
...
train_data = torchvision.datasets.MNIST(
    root='/home/limk/pytorch_distributed/mnist',
    train=True,
    transform=torchvision.transforms.ToTensor(),
    download=DOWNLOAD_MNIST
)
test_data = torchvision.datasets.MNIST(
    root='/home/limk/pytorch_distributed/mnist', train=False
)
...
for epoch in range(epoch_checkpoint,EPOCH):
    for step, (b_x, b_y) in enumerate(train_loader):
        ...
        if step % 100 == 0:
            ...
            'model_state_dict':cnn.module.state_dict(),
