...
parser.add_argument('--epoch', '-e', required=False, default=2, type=str)
...
train_data = torchvision.datasets.MNIST(
    root='/limk/jupyter-performance-test/mnist',
    train=True,
    transform=torchvision.transforms.ToTensor(),
    download=DOWNLOAD_MNIST
)
test_data = torchvision.datasets.MNIST(
    root='/limk/jupyter-performance-test/mnist', train=False
)
